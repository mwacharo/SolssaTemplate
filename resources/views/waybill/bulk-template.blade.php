...
<head>
    ...
    <title>Bulk Waybills - {{ count($waybills) }} Orders</title>
    <style>
        ...
        * {
        ...
        /* Responsive grid for different paper sizes */
        @media print {
            body {
                margin: 0;
                padding: 0;
        ...
        /* All the waybill styles from the original template */
        .header {
            display: flex;
...
<body>
    <div class="page-container">
        @foreach($waybills as $waybillData)
            @php
                $order = $waybillData['order'];
                $barcode = $waybillData['barcode'];
                $company = $waybillData['company'];
            @endphp
            ...
            <div class="waybill-container">
                ...
                <div class="product-section">
                    ...
                    <div class="product-item">
                        <div class="product-name" style="font-style: italic;">
                ...
                <div class="footer">
                    ...
                    <div class="footer-content">
                        {!! Str::limit($company->terms ?? 'Standard terms and conditions apply.', 100) !!}
                    </div>
                </div>
            </div>
        @endforeach
