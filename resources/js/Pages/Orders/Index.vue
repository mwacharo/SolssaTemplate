              ...
              <div class="bg-white p-4 rounded-lg shadow-sm mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <select v-model="orderStore.selectedVendor"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                      <option value="">All sellers</option>
                      <option v-for="vendor in orderStore.vendorOptions" :key="vendor.id" :value="vendor.id">
                        {{ vendor.name }}
                      </option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <select v-model="orderStore.selectedCategory"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                  ...
                  <div>
                    ...
                    <select v-model="orderStore.selectedCity"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                  ...
                  <div>
                    ...
                    <select v-model="orderStore.selectedAgent"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div class="flex items-center">
                      <select v-model="orderStore.selectedOrderStatus"
                  ...
                  <div>
                    ...
                    <input v-model="dateFilters.createdFrom" type="date"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                  ...
                  <div>
                    ...
                    <input v-model="dateFilters.createdTo" type="date"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                      placeholder="Filter by date" />
                  </div>
                </div>
                ...
                <div class="flex justify-center gap-4">
                  <button @click="applyFilters" :disabled="orderStore.loading"
                    ...
                    Filter
                    <svg v-if="!orderStore.loading" class="w-4 h-4" fill="none" stroke="currentColor"
                      viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex gap-2 flex-wrap">
                  ...
                  <Link :href="route('orders.create')"
                    class="px-3 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors flex items-center gap-2 text-sm text-decoration-none"
                    preserve-scroll>
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button @click="exportOrders" :disabled="orderStore.loading"
                  ...
                  <button @click="bulkUpdateStatus" :disabled="selectedOrders.length === 0 || orderStore.loading"
                  ...
                  <button @click="bulkDelete" :disabled="selectedOrders.length === 0 || orderStore.loading"
                        ...
                        <td class="px-4 py-3">
                          <div class="flex flex-col gap-1">
                            <span class="px-2 py-1 text-xs rounded" :class="{
                              'bg-green-500 text-white': order.status === 1,
                              'bg-yellow-500 text-white': order.status === 0,
                              'bg-red-500 text-white': order.status === 2
                            }">
                              {{ orderStatusLabel(order.status) }}
                            </span>
                            <div v-if="order.status_timestamps?.timestamp"
                              class="text-xs text-gray-600 bg-green-100 px-1 py-0.5 rounded">
                              Status at {{ formatDateTime(order.status_timestamps.timestamp) }}
                            </div>
                ...
                <div class="flex justify-between items-center px-6 py-4 bg-gray-50">
                  ...
                  <div class="flex items-center gap-2">
                    <button @click="previousPage"
                      :disabled="orderStore.pagination.current_page === 1 || orderStore.loading"
                    ...
                    <button v-for="page in visiblePages" :key="page" @click="goToPage(page)"
                      :disabled="orderStore.loading" :class="[
                    ...
                    <button @click="nextPage"
                      :disabled="orderStore.pagination.current_page === orderStore.pagination.last_page || orderStore.loading"
                      class="px-3 py-1 border border-gray-300 rounded-md hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed text-sm">
                      Next
                    </button>
                  </div>
...
const debouncedSearch = async () => {
  ...
  if (dateFilters.value.createdFrom && dateFilters.value.createdTo) {
    orderStore.orderDateRange = [dateFilters.value.createdFrom, dateFilters.value.createdTo]
  } else {
...
const resetFilters = async () => {
  ...
  dateFilters.value.createdFrom = ''
  dateFilters.value.createdTo = ''
  await orderStore.applyFilters()
}
...
//   // Open the edit dialog for the selected order
...
// }
// const editOrder = (order) => {
//   orderStore.openEditDialog(order)
// }
// const viewOrder = (order) => {
//   orderStore.openViewDialog(order)
// }     
