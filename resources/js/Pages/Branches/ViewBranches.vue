...
const loadSettings = async (countryId) => {
    ...
    try {
        ...
        if (countriesStore.getCountrySettings) {
            ...
            console.warn(
                "getCountrySettings method not found in store, using default values",
            );
            resetSettingsForm();
        }
    } catch (error) {
...
const saveSettings = async () => {
    ...
    try {
        ...
        if (countriesStore.saveCountrySettings) {
            await countriesStore.saveCountrySettings(
            ...
            console.warn(
                "saveCountrySettings method not found in store, simulating save",
            );
